...
MODEL_FULL = "SimpleMetricEmbedding_acc0.9676.pth"
MODEL_NO0 = "SimpleMetricEmbedding_acc0.8735_removed_class_0.pth"
...
if __name__ == '__main__':
    ...
    # YOUR CODE HERE
    # LOAD TRAINED PARAMS
    model.load_state_dict(torch.load(os.path.join(params_dir, MODEL_FULL), map_location=device))
